...
//	real_name = get_random_name(gender)
//	if(npc_job_title)
...
/mob/living/simple_animal/npc/proc/create_base_icon()
	...
	if(src.gender == FEMALE)
		icon_state = "[my_species.name]_f_s"
	else
		icon_state = "[my_species.name]_m_s"
