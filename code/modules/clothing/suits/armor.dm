...
/obj/item/clothing/suit/armor/metro/pcarrier/black
	name = "black plate carrier"
	desc = "Тактический плитник. Этот - чёрный."
	icon_state = "armorblack"
	item_state = "armorblack"
	blood_overlay_type = "armor"
	armor = list(melee = 15, bullet = 80, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
	strip_delay = 70

/obj/item/clothing/suit/armor/metro/pcarrier/navy
	name = "navy plate carrier"
	desc = "Тактический плитник. Этот - синий."
	icon_state = "armornavy"
	item_state = "armornavy"
	blood_overlay_type = "armor"
	armor = list(melee = 15, bullet = 80, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
	strip_delay = 70

/obj/item/clothing/suit/armor/metro/pcarrier/tan
	name = "tan plate carrier"
	desc = "Тактический плитник. Этот - пустынный."
	icon_state = "armortan"
	item_state = "armortan"
	blood_overlay_type = "armor"
	armor = list(melee = 15, bullet = 80, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
...
/obj/item/clothing/suit/armor/metro/pcarrier/green
	name = "green plate carrier"
	desc = "Тактический плитник. Этот - зелёный."
	icon_state = "armorgreen"
	item_state = "armorgreen"
	blood_overlay_type = "armor"
	armor = list(melee = 15, bullet = 80, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
	strip_delay = 70

/obj/item/clothing/suit/armor/metro/pcarrier/gorka
	name = "'Gorka' plate carrier"
	desc = "Тактический плитник. Этот - особенный."
	icon_state = "gorkavest"
	item_state = "gorkavest"
	blood_overlay_type = "armor"
	armor = list(melee = 15, bullet = 80, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
	strip_delay = 70