...
/obj/item/clothing/head/helmet/metro/tan
	name = "tam helmet"
	desc = "Прочный шлем. Конкретно этот, похоже, принадлежит экспедиционным войскам."
	icon_state = "helmettan"
	item_state = "helmettan"
	armor = list(melee = 15, bullet = 40, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/metro/green
	name = "green helmet"
	desc = "Прочный шлем. Конкретно этот, похоже, принадлежит сухопутным войскам."
	icon_state = "helmetgreen"
	item_state = "helmetgreen"
	armor = list(melee = 15, bullet = 40, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/metro/black
	name = "black helmet"
	desc = "Прочный, чёрный шлем."
	icon_state = "helmetblack"
	item_state = "helmetblack"
	armor = list(melee = 15, bullet = 40, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/metro/navyblue
	name = "navyblue helmet"
	desc = "Прочный шлем. Конкретно этот, похоже, принадлежит военфлоту."
	icon_state = "helmetnavy"
	item_state = "helmetnavy"
	armor = list(melee = 15, bullet = 40, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/metro/gorka
	name = "'Gorka' helmet"
	desc = "Прочный шлем."
	icon_state = "gorkahelmet"
	item_state = "gorkahelmet"
	armor = list(melee = 15, bullet = 40, laser = 10, energy = 10, bomb = 40, bio = 0, rad = 0)
