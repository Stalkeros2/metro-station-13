...
/obj/item/weapon/storage/belt/metro/pouch
	name = "millitary pouch"
	desc = "Тактический подсумок. Такие часто используют в охране/полиции/армии."
	icon_state = "beltsatchel2"
	item_state = "beltsatchel2"
	storage_slots = 8
	max_w_class = 2

/obj/item/weapon/storage/belt/metro/pouch/upgraded
	name = "upgraded millitary pouch"
	desc = "Тактический подсумок. Такие часто используют в охране/полиции/армии."
	icon_state = "satchel_sb"
	item_state = "satchel_sb"
	storage_slots = 12
	max_w_class = 4
