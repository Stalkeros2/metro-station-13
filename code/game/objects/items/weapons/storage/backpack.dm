...
/obj/item/weapon/storage/backpack/stalker/gorka
    name = "tactical bag"
    desc = "Рюкзак, подходящий по цветам к костюму под названием 'Горка'. На л&#255;мке видно инициалы Р.Д."
    icon_state = "gorkapack"
    item_state = "gorkapack"

/obj/item/weapon/storage/backpack/stalker/black
    name = "black rucksack"
    desc = "Чёрный рюкзак, подход&#255;щий дл&#255; дальних вылазок, вмещает в себ&#255; много всего."
    icon_state = "rucksack"
    item_state = "rucksack"
