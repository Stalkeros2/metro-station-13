...
/obj/item/weapon/storage/fancy/civilian_medkit
	icon = 'icons/obj/food/containers.dmi'
	icon_state = "orangebox5"
	icon_type = "orange"
	name = "orange medkit"
	desc = "Гражданска&#255; аптечка дл&#255; оказани&#255; ПМП. Внутри лежат настораживающие инжекторы."
	storage_slots = 5
	can_hold = list(/obj/item/weapon/reagent_containers/pill/stalker/injector/sj1)
	spawn_type = /obj/item/weapon/reagent_containers/pill/stalker/injector/sj1

/obj/item/weapon/storage/fancy/army_medkit
	icon = 'icons/obj/food/containers.dmi'
	icon_state = "bluebox5"
	icon_type = "blue"
	name = "blue medkit"
	desc = "Армейска&#255; аптечка, такую когда-то использовали военные медики дл&#255; быстрого восстановлени&#255; боеспособности раненных."
	storage_slots = 5
	can_hold = list(/obj/item/weapon/reagent_containers/pill/stalker/injector/etg_c)
	spawn_type = /obj/item/weapon/reagent_containers/pill/stalker/injector/etg_c

/obj/item/weapon/storage/fancy/scientific_medkit
	icon = 'icons/obj/food/containers.dmi'
	icon_state = "yellowbox5"
	icon_type = "yellow"
	name = "yellow medkit"
	desc = "Экспериментальна&#255; армейска&#255; аптечка, не получивша&#255; в старом мире особого распространени&#255;. Внутри закреплена свора настораживающих инжекторов."
	storage_slots = 5
	can_hold = list(/obj/item/weapon/reagent_containers/pill/stalker/injector/sj6)
	spawn_type = /obj/item/weapon/reagent_containers/pill/stalker/injector/sj6
