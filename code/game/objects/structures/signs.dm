...
/obj/structure/sign/metro/hospital
	name = "hospital"
	desc = "Обычно, этот знак обозначает - что р&#255;дом находитс&#255; пункт оказани&#255; первой помощи. Может и не только."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "redcross"

/obj/structure/sign/metro/hospital_poster1
	name = "hospital poster"
	desc = "Плакат с различной информацией о человеческом теле."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "sancposter"

/obj/structure/sign/metro/hospital_poster2
	name = "hospital poster"
	desc = "Плакат с различной информацией о человеческом теле."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "sancposter2"

/obj/structure/sign/metro/hospital_poster3
	name = "hospital poster"
	desc = "Плакат с различной информацией о человеческом теле."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "sancposter3"

/obj/structure/sign/metro/hospital_poster4
	name = "hospital poster"
	desc = "Плакат с различной информацией о человеческом теле."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "sancposter4"

/obj/structure/sign/metro/hospital_poster5
	name = "hospital poster"
	desc = "Плакат с различной информацией о человеческом теле."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "sancposter5"

/obj/structure/sign/metro/bandits_flag
	name = "flag"
	desc = "Изр&#255;дно потрёпанное полотно, с символикой одной из наиболее известных в метро бандитских группировок."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "pcross"

/obj/structure/sign/metro/trc_flag
	name = "flag"
	desc = "Флаг с символикой КР."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "z"

/obj/structure/sign/metro/poster
	name = "poster"
	desc = "Пропаганда."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "poster_info"

/obj/structure/sign/metro/poster2
	name = "poster"
	desc = "Пропаганда."
	icon = 'icons/stalker/lohweb/decals.dmi'
	icon_state = "poster_nt_treason"

/obj/structure/sign/metro/poster3
	name = "poster"
	desc = "Пропаганда."
	icon = 'icons/stalker/lohweb/decals.dmi'
