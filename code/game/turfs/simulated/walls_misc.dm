...
/turf/simulated/wall/metro
	canSmoothWith = list(
	/turf/simulated/wall/metro/v1,
	/turf/simulated/wall/metro/v2
	)
	smooth = SMOOTH_TRUE
...
/turf/simulated/wall/metro/v1
	name = "wall"
	desc = "A huge chunk of hull"
	icon = 'icons/stalker/lohweb/lev.dmi'
	icon_state = "rwall"
	walltype = "metall"
	canSmoothWith = list(/turf/simulated/wall/metro/v1)

/turf/simulated/wall/metro/v2
	name = "wall"
	desc = "Собранна&#255; из говна и палок стеночка, ничего особенного"
	icon = 'icons/stalker/lohweb/walls2.dmi'
	icon_state = "rwall"
	walltype = "metall"
	canSmoothWith = list(/turf/simulated/wall/metro/v2)
