...
/sidoritem/firstaid/stalker
	name = "Firstaid"
	itemtype = /obj/item/weapon/reagent_containers/pill/stalker/injector/sj1
	cost = 500
	words = list("Аптечку" = 5, "аптечку" = 5, "Атпечка" = 5, "аптечка" = 5)

/sidoritem/firstaid/army
	name = "Army firstaid"
	itemtype = /obj/item/weapon/reagent_containers/pill/stalker/injector/sj6
	cost = 1000
...
/sidoritem/antirad
	name = "Azure"
	itemtype = /obj/item/weapon/reagent_containers/hypospray/medipen/stalker/zelionka
	cost = 700
...
/sidoritem/sp9x39vint
	name = "sp9x39vint"
	itemtype = /obj/item/ammo_box/magazine/stalker/svd
	cost = 700
