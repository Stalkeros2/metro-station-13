...
/obj/effect/spawner/lootdrop/stalker/mobspawner/spider
	name = "dog mutant"
	lootcount = 1
	radius = 10 //Радиус разброса лута
	cooldown = 6000 //Кол-во минут * 1000 - кд шитспавна
	loot = list(/mob/living/simple_animal/hostile/mutant/spider = 100)
...
/obj/effect/spawner/lootdrop/stalker/mobspawner/ghoul_spawner
	name = "ghoul mutant"
	lootcount = 1
	radius = 1
	cooldown = 7000
	loot = list(/mob/living/simple_animal/hostile/mutant/ghoul = 100)

/obj/effect/spawner/lootdrop/stalker/mobspawner/ghoulupper_spawner
	name = "ghoul mutant"
	lootcount = 1
	radius = 1
	cooldown = 7000
	loot = list(/mob/living/simple_animal/hostile/mutant/ghoulupper = 100)
