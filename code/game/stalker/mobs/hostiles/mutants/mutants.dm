...
/mob/living/simple_animal/hostile/mutant/ghoulupper
	name = "Mutant dog"
	desc = "Один из наименее пострадавших представителей старого мира. Дворова&#255; псина, одичавша&#255; и получивша&#255; куда большую силу, чем ранее."
	...
	see_invisible = SEE_INVISIBLE_MINIMUM
	see_in_dark = 2
	deathmessage = "The ghoul seizes up and falls limp!"
	del_on_death = 0
	minbodytemp = 0
	maxbodytemp = 1500
	environment_smash = 0
...
/mob/living/simple_animal/hostile/mutant/ghoul
	name = "Ghoul"
	desc = "Упырь - и в Африке упырь. Таких стоит избегать, ход&#255; по тоннел&#255;м в одиночку."
	eng_desc = "Just another ghoul"
	turns_per_move = 5
	speed = 2
	a_intent = "harm"
	...
	deathmessage = "The ghoul seizes up and falls limp!"
	layer = MOB_LAYER - 0.1
	loot = list(/obj/item/weapon/stalker/loot/flesh_eye, /obj/nothing, /obj/nothing)
	random_loot = 1
	atmos_requirements = list("min_oxy" = 0, "max_oxy" = 0, "min_tox" = 0, "max_tox" = 0, "min_co2" = 0, "max_co2" = 0, "min_n2" = 0, "max_n2" = 0)
	ranged = 1
