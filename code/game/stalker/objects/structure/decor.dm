...
/obj/structure/stalker/cacheable/computer
	...
	desc = "Кто-то &#255;вно не любит технику."
...
/obj/structure/stalker/letuchka
	...
	desc = "Поржавевша&#255; бронелетучка. На вр&#255;д ли ещё работоспособна."
	eng_desc = "Broken letuchka."
	icon = 'icons/Unsorted/CVRT (1).dmi'
	icon_state = "CVR(T)"
	density = 1

/obj/structure/stalker/bcar
	name = "broken car"
	desc = "Разобранна&#255; по част&#255;м машина."
	eng_desc = "Broken car."
...
/obj/structure/stalker/expedition_car
	name = "car"
	desc = "Сделанное из подручных материалов подобие транспорта, с местом дл&#255; двух человек. Хорошо укрепленно, правда едет, кажетс&#255;, на св&#255;том духе."
	eng_desc = "Car."
	icon = 'icons/stalker/some_stuff/medium_vehicles.dmi'
...
/obj/structure/stalker/cacheable/computer2
	name = "synthesizer"
	desc = "Синтезатор дл&#255; различного рода реагентов."
